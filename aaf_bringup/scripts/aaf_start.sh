...
tmux send-keys "HOST_IP=192.168.0.100 DISPLAY=:0 rosparam set /deployment_language german && roslaunch strands_bringup strands_ui.launch mary_machine:=werner-right-cortex mary_machine_user:=strands"
